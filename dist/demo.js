...
},{"../src/lib/request.js":5}],2:[function(require,module,exports){
  ...
  return new Promise(function (resolve, reject) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        ...
        var response = {
          code: xhr.status,
          headers: headersStrToObj(xhr.getAllResponseHeaders()),
...
var getJsonpCount = 0;
var getJsonp = function (url, opts) {
  
  return new Promise(function (resolve, reject) {
    
    opts = isObject(opts) ? opts : {};
    
    var key = opts.key || 'callback';    
